...
import com.afiq.ezsmartpark1.Activity.CameraIntent;
...
public class FirebaseStorage extends AppCompatActivity {
    ...
    private Uri imgUri;
    Button buckyButton,menu_authority;

    public static final String FB_STORAGE_PATH = "image/";
    public static final String FB_DATABASE_PATH = "Authority/Plate Number Images";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buckyButton = (Button) findViewById(R.id.btncapture);
        menu_authority = (Button) findViewById(R.id.menu_authority);
        ...
        buckyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, CameraIntent.class);
                startActivity(intent);

            }
        });

        menu_authority.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        if (imgUri != null) {
            ...
            ref.putFile(imgUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    String date = listItemCreationDate.toString();
                    ...
                    mDatabaseRef.child(date).child(uploadId).setValue(imageUpload);
