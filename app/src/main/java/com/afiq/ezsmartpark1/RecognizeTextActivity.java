...
import com.afiq.ezsmartpark1.utils.CharDetectOCR;
import com.afiq.ezsmartpark1.utils.CommonUtils;
import com.afiq.ezsmartpark1.view.TouchImageView;
import com.google.firebase.auth.FirebaseAuth;
import com.google.firebase.auth.FirebaseUser;

import static com.afiq.ezsmartpark1.utils.CommonUtils.info;
...
public class RecognizeTextActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		recognizeResult = (EditText) findViewById(R.id.check_plate_fill);
		...
		btnCheck.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//    updateUI(currentUser);
					...
					String namevalue = recognizeResult.getText().toString();
					Intent intent = new Intent(RecognizeTextActivity.this, AuthorityCheckPark.class);
