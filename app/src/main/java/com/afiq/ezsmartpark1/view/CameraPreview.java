package com.afiq.ezsmartpark1.view;
...
import com.afiq.ezsmartpark1.AndroidCamera;
		...
		protected void onDraw(Canvas canvas) {
			if (lstRectArea != null && lstRectArea.size() > 0) {
				for (Rect rect : lstRectArea) {
					canvas.drawRect(rect.left * 0.1F, rect.top * 1.0F, rect.right * 1.0F, rect.bottom * 1.0F,
							drawingPaint);
				}
			}
		}
